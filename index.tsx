    ...
    <>
      <AppBar position="static" style={{ backgroundColor: getBackgroundColor(), borderBottom: '1px solid #444' }}>
        <Toolbar>
          ...
          <Typography variant="h6" style={getColorStyle()}>Mon Site Minimaliste</Typography>
          <Menu
            anchorEl={anchorEl}
      ...
      >
        <Typography variant="h3">
          <StyledText mode={mode}>Un autre contenu clair</StyledText>
        </Typography>
        <Typography variant="body1" style={{ marginTop: '16px' }}>
          <StyledText mode={mode}>Profitez de notre site avec un design clair et des couleurs vibrantes.</StyledText>
        </Typography>
      </MotionContainer>
